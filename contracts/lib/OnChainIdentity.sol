...
library IdentityLib {
    ...
    /**
     * @dev Data structure of the Identity library
     * Id
    ...
    struct Data {
        ...
        bool isRootsOnlyClaimsTree; // shouldn't take additional storage slot;
    ...
    function initialize(
        ...
        self.trees.claimsTree.initialize(depth, _isRootsOnlyClaimsTree);
        self.trees.revocationsTree.initialize(depth, false);
        self.trees.rootsTree.initialize(depth, false);
    ...
    function addClaimsTreeRoot(Data storage self, uint256 root) external {
        self.trees.claimsTree.addRootEntry(root);
    }
