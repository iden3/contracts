...
import {BytesParsing} from "./bytes/BytesParsing.sol";
...
abstract contract QueryResponse is Ownable2StepUpgradeable {
    ...
    function _QueryResponse_init(address _wormholeCoreContractAddr) internal onlyInitializing {
         wormhole = IWormhole(_wormholeCoreContractAddr);
    }
