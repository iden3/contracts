...
contract LinkedMultiQueryStable5Validator is Ownable2StepUpgradeable, RequestValidatorBase, ERC165 {
    ...
    string internal constant CIRCUIT_ID = "linkedMultiQuery5";
    uint256 internal constant QUERIES_COUNT = 5;

    struct PubSignals {
        uint256 linkID;
        uint256 merklized;
        uint256[QUERIES_COUNT] operatorOutput;
        uint256[QUERIES_COUNT] circuitQueryHash;
    }
