...
contract LinkedMultiQueryStable3Validator is Ownable2StepUpgradeable, RequestValidatorBase, ERC165 {
    ...
    string internal constant CIRCUIT_ID = "linkedMultiQuery3";
    uint256 internal constant QUERIES_COUNT = 3;
