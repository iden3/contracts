...
contract StateV3_UpgradeTest is OwnableUpgradeable {
    /**
    ...
    using SmtV3_UpgradeTest for SmtData;
    using SmtV3_UpgradeTest for SmtDataV2;
    ...
    function getSmtProof(uint256 _index) public view returns (Proof memory) {
