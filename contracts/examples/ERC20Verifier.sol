...
contract ERC20Verifier is ERC20, ZKPVerifier {
    ...
    string private constant CHALLENGE = "challenge";
    uint256 public immutable tokenAmountForAirdropPerId = 5 * 10**uint256(decimals());
    ...
    function _beforeProofSubmit(
        ...
        address addr = GenesisUtils.int256ToAddress(inputs[validator.inputIndexOf(CHALLENGE)]);
    ...
    function _afterProofSubmit(
        ...
        uint256 id = inputs[validator.inputIndexOf(CHALLENGE)];
