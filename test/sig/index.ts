...
const testCases: any[] = [
  {
    ...
    proofJson: require("./data/valid_sig.json"),
  },
  {
    name: "Validation of proof failed",
    issuerStateTransitions: [require("./data/issuer_state_transition.json")],
    proofJson: require("./data/invalid_sig.json"),
  ...
  //   proofJson: require("./data/user_non_genesis_sig.json"),
  //   errorMessage: "",
  // },
  // {
...
describe("Atomic Signature Validator", function () {
  ...
  //   const token: any = await deployToken(sig.address);
  ...
  //   const token: any = await deployERC20ZKPToken(sig.address);
  //   await publishState(state, require("./data/user_state_transition.json"));
