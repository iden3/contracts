...
import CredentialAtomicQueryV3Stable_16_16_64_16_32ValidatorModule from "../../../ignition/modules/deployEverythingBasicStrategy/credentialAtomicQueryV3Stable_16_16_64_16_32Validator";
...
describe("Atomic V3-Stable Validator", function () {
  ...
  async function deployContractsFixture() {
    ...
    const {
      state: stateContract,
      credentialAtomicQueryV3Stable_16_16_64_16_32Validator: validator,
    } = await ignition.deploy(CredentialAtomicQueryV3Stable_16_16_64_16_32ValidatorModule, {
  ...
  it("check version", async () => {
    ...
    expect(version).to.be.equal(contractsInfo.VALIDATOR_V3_STABLE_16_16_64_16_32.version);
  });
  ...
  it("Test supported circuits", async () => {
    ...
    expect(supportedCircuitIds[0]).to.be.equal("credentialAtomicQueryV3OnChain-16-16-64-16-32");
  });
});
