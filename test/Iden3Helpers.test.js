...
const mimcUnit = require("circomlib/src/mimc_gencontract.js");
const { ethers } = require("hardhat");
const { expect } = require("chai");
const SEED = "mimc";

describe("Iden 3 helpers functions", () => {
    ...
    before(async () => {
        ...
        // Deploy mimc7
        const InsMimcUnit = await ethers.getContractFactoryFromArtifact({
            contractName: "",
            sourceName: "",
            abi: mimcUnit.abi,
            bytecode: mimcUnit.createCode(SEED, 91),
            deployedBytecode: "",
            linkReferences: {},
            deployedLinkReferences: {},
        }, owner);

        insMimcUnit = await InsMimcUnit.deploy();
        await insMimcUnit.deployed();

        // Deploy iden3 helpers test
        const HelpersTest = await ethers.getContractFactory("Iden3HelpersTest");
        insHelpers = await HelpersTest.deploy(insMimcUnit.address);
        await insHelpers.deployed();
    });

    it("Parse merkle tree proof existence", async () => {
        const proof = '0x0103000000000000000000000000000000000000000000000000000000000007' + '0b17095aa925dc78a07fdb53f1589890d018b61d9ec2dedc800ffd5a06c6d37a' + '137d66cc357c7ce5d3b8dd239492f04a84c189c7784a081e705def9846ac7d02' + '12ad30ae8e4ba3c5bed549923763c6cdf1d32466fba659448ce987a6b6cf3d08';
    ...
    it("Parse merkle tree proof non-existence", async () => {
        const proof = '0x0307000000000000000000000000000000000000000000000000000000000043' + '0b17095aa925dc78a07fdb53f1589890d018b61d9ec2dedc800ffd5a06c6d37a' + '137d66cc357c7ce5d3b8dd239492f04a84c189c7784a081e705def9846ac7d02' + '1f777df2736b8f339bc822ce0e82681c3d5712d6c8c1681b9f8a8da33f027bd3' + '2bd5a51b497073b952be60de9a83802c64c49aececbd504cbc8269bef021e9e6' + '06d4571fb9634e4bed32e265f91a373a852c476656c5c13b09bc133ac61bc5a6';
        const res = await insHelpers.testParserProof(proof);
        expect(res[0]).to.be.equal(true);
        expect(res[1]).to.be.equal(true);
        expect(res[2]).to.be.equal(7);
        expect(res[3].toHexString()).to.be.equal('0x43');
        expect(res[4].toHexString()).to.be.equal('0x2bd5a51b497073b952be60de9a83802c64c49aececbd504cbc8269bef021e9e6');
        expect(res[5].toHexString()).to.be.equal('0x06d4571fb9634e4bed32e265f91a373a852c476656c5c13b09bc133ac61bc5a6');
    });
    ...
    it("Get hi and hv from entry", async () => {
        ...
        const hi = '0x0718f79acd724288c56a0b7c7de9c61ad235245c64b9fb02e9de9e0a4d5d648b';
        const hv = '0x06d4571fb9634e4bed32e265f91a373a852c476656c5c13b09bc133ac61bc5a6';
        expect(res.hi.toHexString()).to.be.equal(hi);
        expect(res.hv.toHexString()).to.be.equal(hv);
    });
    ...
    */
    ...
    it("check proof-of-existence", async () => {
        ...
        const mtp = '0x0007000000000000000000000000000000000000000000000000000000000043' + '0b17095aa925dc78a07fdb53f1589890d018b61d9ec2dedc800ffd5a06c6d37a' + '137d66cc357c7ce5d3b8dd239492f04a84c189c7784a081e705def9846ac7d02' + '1f777df2736b8f339bc822ce0e82681c3d5712d6c8c1681b9f8a8da33f027bd3';
    ...
    it("check proof-of-non-existence non-empty", async () => {
        // Data extracted from iden3js sparse merkle tree
        const root27 = '0xa00c5f1dccd8d96374714034401483317932d0ddfd95e98b68b352';
        const mtp = '0x0103000000000000000000000000000000000000000000000000000000000007' + '0b17095aa925dc78a07fdb53f1589890d018b61d9ec2dedc800ffd5a06c6d37a' + '137d66cc357c7ce5d3b8dd239492f04a84c189c7784a081e705def9846ac7d02' + '12ad30ae8e4ba3c5bed549923763c6cdf1d32466fba659448ce987a6b6cf3d08';
