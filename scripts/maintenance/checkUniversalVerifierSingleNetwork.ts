...
/*const universalVerifierAddress = "0xfa1d72bbEBdEBc16d00e6e51B164746B297de688"; //"0x246c45aD0afF05617080606bc9aFEac12905bF99"; //"0xc89fA32a60aa91f0AbB2225c9e338bf8F634F20d"; //contractsInfo.UNIVERSAL_VERIFIER.unifiedAddress;
...
async function testVerification(verifier: Contract) {
  ...
  const stateContractAddress = "0x34fAA91432eA45d243B7E321B38C927224d68d7F"; //"0x34fAA91432eA45d243B7E321B38C927224d68d7F"; //await getStateContractAddress();
