...
export const AuthV3_8_32ValidatorProxyModule = buildModule("AuthV3_8_32ValidatorProxyModule", (m) => {
...
const AuthV3_8_32ValidatorProxyFinalImplementationModule = buildModule(
  ...
  (m) => {
    ...
    const { contract: newImplementation } = m.useModule(AuthV3_8_32ValidatorNewImplementationAtModule);
    const state = m.useModule(StateAtModule).proxy;
